...
{
    public class Hills : ITopography
    {
        ...
        public Hills(CoreEnums.RegionSize size, IClimate climate)
        {
        ...
        {
            return new List<ITopography> { new Highlands(), new Lowlands(), new Plains(), new Valleys() };
        }
        ...
        {
            return new List<IFeatures> { new Forest(), new Caves(), new Fumaroles(), new Ridges(), new Rivers(), new Shrubland(), new Talus() };
        }
    }
}