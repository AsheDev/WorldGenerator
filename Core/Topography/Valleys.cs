...
{
    public class Valleys : ITopography
    {
        ...
        public Valleys(CoreEnums.RegionSize size, IClimate climate)
        {
        ...
        /// <summary>
        /// Populates the available features that are allowed within this topography. 
        ...
        {
            return new List<IFeatures> { new Bog(), new Caves(), new Faults(), new Forest(), new Fumaroles(), new Karst(), new Ridges(), new Rivers(), new Shrubland() };
        }   
    }
}