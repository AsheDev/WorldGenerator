...
{
    public class Mountains : ITopography
    {
        ...
        public Mountains(CoreEnums.RegionSize size, IClimate climate)
        {
        ...
        {
            return new List<ITopography> { new Highlands() };
        }
        ...
        {
            return new List<IFeatures> { new Caves(), new Faults(), new Forest(), new Fumaroles(), new Karst(), new Ridges(), new Rivers(), new Talus() };
        }
    }
}