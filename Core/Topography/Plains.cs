...
{
    public class Plains : ITopography
    {
        ...
        {
            return new List<ITopography> { new Hills(), new Valleys(), new Lowlands() };
        }
        ...
        {
            return new List<IFeatures> { new Bog(), new Craters(), new Dunes(), new Faults(), new Forest(), new Rivers(), new Shrubland() };
        }
    }
}
